# How to setup EdgeTTS on Home Assistant

Video: [https://www.youtube.com/watch?v=LMxd6fsEv9c](https://www.youtube.com/watch?v=LMxd6fsEv9c) (from 00:00 → 04:30)
...
3. Manually install the **EdgeTTSServer** and **EdgeTTS**:
...
4. Last step:
    1. Speech script:
        ...
        2. `text`: Your input text
        3. `voice`: Select the voice for your language
        4. `cache`: You can decide that it can be cached or not.
        5. Example: (it’s **Tiếng Việt - Vietnamese** script)
        
        ```jsx
        sequence:
          - action: pyscript.speech
            metadata: {}
            data:
              ...
              cache: false
        alias: edgetts speech
        description: ""
        ```
        

1. Supported languages: (Current)
